	...
	<section id="container" class="zerogrid">
		<div class="wrap-container">
			<div class="contact-form">
										...
										if ($stmt->execute()){
											while ($fila=$stmt->fetch()){
												echo "<tr>";
													...
													echo "<td><a href='mod_categorias.php?idcat={$fila['id']}' class='btn-modificar'>Modificar</a>
														<a href='eliminar_cat.php?idcat={$fila['id']}' class='btn-eliminar'>Eliminar</a></td>";
												echo "</tr>";
											}
										}
									} catch (PDOException $e){
				...
				<form id="catform" action="alta_categorias.php">
					<div class="t-center">
